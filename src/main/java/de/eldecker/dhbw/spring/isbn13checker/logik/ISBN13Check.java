...
/**
 * Bean-Klasse mit Logik für die eigentliche ISBN-13-Prüfung.
 */
@Service
public class ISBN13Check {
    ...
    /**
     * Methode prüft, ob die Prüfziffer der als Argument übergbebenen ISBN-13 korrekt ist.
     * <br><br>
     * 
     ...
     * 
     * @param isbn ISBN-13 als String, z.B. "978-3-16-148410-0"
     * 
    ...
    public boolean isbn13Pruefziffer13IstKorrekt( String isbn ) {
        ...
        // alle Zeichen entfernen, die keine Ziffer sind
        final String ziffernString = isbn.replaceAll( "[^0-9]", "" );
        
        if ( ziffernString.length() != 13 ) {
            
            LOG.error( "ISBN hat nicht 13 Ziffern sondern {} Ziffern.", 
